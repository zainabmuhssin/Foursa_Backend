...
class PostDB(Base):
    ...
    location = Column(String)  # موقع الوظيفة (اختياري)
...
class NotificationDB(Base):
    ...
    sender_id = Column(Integer, nullable=True)  # ID المرسل (لإشعارات الرسائل)
    sender_type = Column(String, nullable=True)  # نوع المرسل (manager/jobseeker)
...
class FollowDB(Base):
    ...
    follower_type = Column(String, nullable=True)  # 'manager' or 'jobseeker'
    following_type = Column(String, nullable=True)
